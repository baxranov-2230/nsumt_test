...
import { DeleteQuestionApi, GetAllQuestionApi } from "../../Api/QuestionApi.jsx";


function ListQuestion() {
    const [isModalOpen, setIsModalOpen] = useState(null);
    const { isError, isSuccess, isLoading, data, error, refetch } = useQuery({
        queryKey: ["list-question"], queryFn: GetAllQuestionApi,
    });

    const questionMutation = useMutation({
        mutationKey: ["delete-question"],
        mutationFn: DeleteQuestionApi, onSuccess: (data) => {
                    ...
                    <table className="w-full">
                        ...
                        <tbody>
                            {data?.map((question, index) => {
                                return (<tr className="border-t" key={question?.id}>
